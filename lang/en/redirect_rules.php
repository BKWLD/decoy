...
return [
    ...
    'form.from_help' => 'A URL path, beginning after "'.Request::root().'/". This can contain wildcards in the form of a <code>%</code>. For instance, to match all URLs beginning with "blog/", use <code>blog/%</code>.',
