-#
	...
	- $sidebar->add(Former::listing('App\Video'))
	- $sidebar->add(Former::listing('App\Photo')->take(30))
	...
	%fieldset
		...
		!= Former::select('category_id', 'Categories')->addOption(null)->fromQuery(App\Category::ordered()->get(), 'name')
