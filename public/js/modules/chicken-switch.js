...
define(function(require) {
	...
	// links on edit pages
	function register() {
		$('.listing').find('.delete-now, .remove-now').add('.actions .delete').on('click', prompt);
	}
	...
	function prompt(e, bypass) {
		...
		$el.popover({
			trigger: 'manual',
			content: '<p class="text-center">Are you sure?</p><div><a href="#" class="btn btn-danger"><i class="icon-trash icon-white"></i> Yes</a> <a href="#" class="btn btn-default">Cancel</a></div>',
			html: true,
