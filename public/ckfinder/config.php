...
$config['LicenseName'] = config('decoy.wysiwyg.ckeditor.license_name');
$config['LicenseKey'] = config('decoy.wysiwyg.ckeditor.license_key');
...
*/
$baseUrl = config('decoy.wysiwyg.ckeditor.upload_dir');
