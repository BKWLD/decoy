...
<form class="many-to-many-form pull-right" data-js-view="many-to-many<?=!empty($tags)?'-tags':null?>" data-controller-route="<?=action($controller)?>" data-parent-id="<?=$parent_id?>">
