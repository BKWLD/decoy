...
<form class="many-to-many-form" data-js-view="many-to-many<?=!empty($tags)?'-tags':null?>" data-controller-route="<?=Html::controller($controller)?>" data-parent-id="<?=$parent_id?>" data-parent-controller="<?=$parent_controller?>">
