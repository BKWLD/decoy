...
class Router {
	...
	public function registerAdmins() {
		Route::get($this->dir.'/admins/{id}/disable', array('uses' => 'Bkwld\Decoy\Controllers\Admins@disable', 'as' => 'decoy/admins@disable'));
		Route::get($this->dir.'/admins/{id}/enable', array('uses' => 'Bkwld\Decoy\Controllers\Admins@enable', 'as' => 'decoy/admins@enable'));
	}
